...
2. Logging methods:
   ...
   ```
    ...
    <p style="color:yellow">[WARNING] - Example warning message (__main__)</p>
    <p style="color:red">[Error] - Example error message (__main__)</p>
    <b><p style="color:red">[Error] - Example error message (__main__)</p></b>
